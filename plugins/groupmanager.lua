...
data[tostring(target)]["mutes"]["mute_keyboard"] = "no"
 save_data(_config.moderation.data, data) 
if not lang then
return "*Mute Keyborad* _Has Been Disabled_"
else
...
if matches[1] == "unlock" or matches[2] == "باز" and is_mod(msg) then
local target = msg.to.id
if matches[2] == "link" or matches[1] == "لینک" then
return unlock_link(msg, data, target)
end
if matches[2] == "tag" or matches[1] == "تگ" then
return unlock_tag(msg, data, target)
end
if matches[2] == "mention" or matches[1] == "منشن" then
return unlock_mention(msg, data, target)
end
if matches[2] == "arabic" or matches[1] == "فارسی" then
return unlock_arabic(msg, data, target)
end
if matches[2] == "edit" or matches[1] == "ویرایش" then
return unlock_edit(msg, data, target)
end
if matches[2] == "spam" or matches[1] == "اسپم" then
return unlock_spam(msg, data, target)
end
if matches[2] == "flood" or matches[1] == "فلود" then
return unlock_flood(msg, data, target)
end
if matches[2] == "bots" or matches[1] == "ربات" then
return unlock_bots(msg, data, target)
end
if matches[2] == "markdown" or matches[1] == "فونت" then
return unlock_markdown(msg, data, target)
end
if matches[2] == "webpage" or matches[1] == "وبسایت" then
return unlock_webpage(msg, data, target)
end
if matches[2] == "pin" or matches[1] == "سنجاق" and is_owner(msg) then
return unlock_pin(msg, data, target)
end
end
if matches[1] == "mute" or matches[1] == 'صامت' and is_mod(msg) then
local target = msg.to.id
...
if matches[1] == "unmute" or matches[1] == 'مصوت' and is_mod(msg) then
local target = msg.to.id
if matches[2] == "all" or matches[2] == "همه" then
...
if matches[1] == 'newlink' or matches[1] == 'لینک جدید' and is_mod(msg) then
 ...
 tdcli.exportChatInviteLink(msg.to.id, callback_link, nil)
   ...
   local is_link = msg.text:match("^([https?://w]*.?telegram.me/joinchat/%S+)$") or msg.text:match("^([https?://w]*.?t.me/joinchat/%S+)$")
    ...
    if matches[1] == 'linkpv' or matches[1] == 'لینک پی وی' and is_mod(msg) then
      local linkgp = data[tostring(chat)]['settings']['linkgp']
      if not linkgp then
      if not lang then
        return "_First create a link for group with using_ /newlink\n_If bot not group creator set a link with using_ /setlink"
    ...
    return "_Group_ *flood* _sensitivity has been set to :_ *[ "..matches[2].." ]*"
     ...
     if not lang then
       ...
       if not lang then
			...
			if matches[2] == 'about' or matches[1] == 'درباره' then
